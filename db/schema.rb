...
ActiveRecord::Schema[8.0].define(version: 2025_04_09_012619) do
  ...
  create_table "restaurantes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_restaurantes_on_category_id"
  end
  ...
  add_foreign_key "product_categories", "restaurantes"
  add_foreign_key "products", "product_categories"
  add_foreign_key "restaurantes", "categories"
end
